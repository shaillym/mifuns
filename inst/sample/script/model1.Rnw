...
boot <- read.table('../nonmem/1035.boot/boot.table',as.is=TRUE)
...
latex(
	tab,
	file='../report/table/paramEsts_1035.tex',
	rowname=NULL,
	caption='Parameter Estimates from Population Pharmacokinetic Model Run 1035',
	caption.lot='Model 1035 Parameters',
	label='m1003',
	where='ht',
	table.env=FALSE
)
